...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://tymski.github.io/10minutes/";
    public static String WEBAPP_HOST = "tymski.github.io/10minutes/"; // used for checking Intent-URLs
